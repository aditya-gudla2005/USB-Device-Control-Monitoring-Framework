...
This project includes a lightweight Flask-based web interface
that visualizes USB device activity and file transfer logs
generated by the monitoring agent.
